    ...
    <footer className="bg-[#0B061A] border-t border-white/10 text-white pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 flex flex-col md:flex-row items-center justify-between gap-4 text-white/40 text-sm">
        ...
        <div className="flex items-center gap-4">
          <Link href="https://x.com/RajSingh_io" className="hover:text-white transition">
            <Twitter size={18} />
          </Link>
          <Link href="https://github.com/rajsingho3/StudyMate-AI" className="hover:text-white transition">
            <Github size={18} />
          </Link>
        </div>
      </div>
